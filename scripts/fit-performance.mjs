...
const software=process.argv.includes('--software');const folder='artifacts/fit-pass/'+(process.argv[2]||'before');mkdirSync(folder,{recursive:true});
...
const results=[];
try{for(const [label,port,quality] of [['low',5180,'low'],['medium',5180,'medium'],['high',5180,'high']]){
