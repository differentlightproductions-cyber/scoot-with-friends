...
## Stage3 / arms / colorways (local only)
Allowance6points from91 to97; reserve1point for build/report. Userbrief explicitly prohibits publish/push/packaging this round. Root owns character arm drivers, stage3_riding owns physics/tests/report, wood_lighten owns finish, colorway_selector owns scooter UI color bug. Existing v28 live and Windows remain safe.

Stage3: owner now authorizes existingSite publication and privateGitHub upload, overriding thisbrief localonly. Stage2 9/9; Stage3 16/16; manual65checks; anatomy48poses; fulltests/build passed. Grindexit nowpreservesgrind-ownedmomentumandavoidsboxredirect; joinedcontacttolerance.2s. Midbar onfootgrip andfixedarmhinge; lighteramber+silvermetal; prominentauthoredcolorways verifiedsavedBlack. Whiprewindqueuesuntilcompletedwhip/footkick; secondblockeduntilreturnmotion,6focusedtests. Online lobbies deferred. Remaining: ramp perimeter outlines and importedarm/sleeve visualquality are NOT artist-approved; do not claim finishedgraphics. Manual/grindcross-transitions not rerun. No additionalfeaturework beforedelivery; originalassets andv28 preserved.

### First-person follow-up (September 21)
Owner extended remaining usage for a focused camera fix. Local imported rider now masks head/torso/hips/upper sleeves in the first-person color pass using skin weights; forearms, hands, knees, scooter and full-body shadow remain. Third-person and remote models keep full geometry. Default horizontal FOV is 110 degrees; old 90-degree default migrates once. Mounted eye anchor sits slightly behind the head to keep grips ahead of the lens during preload; mounted look pitches downward to retain the deck in view. Camera state updates the mask in the same render frame. Full unit suite and production build passed. Browser visual checks recorded separately. Online lobbies deferred; ramp outline and broader sleeve/anatomy art polish still pending.



First-person browser check passed at 1280x720 (Chrome/SwiftShader): mounted, crouch, tailwhip, bri, on-foot; 110-degree FOV, hand/bar framing, tailwhip deck, mask restoration without head bone deformation, no browser errors. Original bri pose preserved; deck naturally exits view overhead. Root reviewed all three images. Sleeve cutoff edges and source clothing quality remain art limitations; this pass resolves camera/body obstruction, not final character art. Images bundled in artifacts/first-person-view/first-person-view-images.zip.
