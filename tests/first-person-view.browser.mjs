...
try{
 ...
 await page.evaluate(async()=>{const g=window.__LAZER;g.testing(true);await g.startSession('outdoor',true);g.advance(.4,{},false);g.camera.view='first';g.camera.firstPersonFov=110;});
