export const MAPS = [
  ...
  {id:'techno_gravity',name:'Techno Gravity Shop',type:'Independent shop / Rideable frontage + DIY alley',description:'Explore the local shop, inspect parts, spend earned Credit and ride the homemade alley spot.',preview:'/previews/techno-gravity.webp',spawn:{x:0,z:-11,yaw:0},environment:'shop'},
] as const;
