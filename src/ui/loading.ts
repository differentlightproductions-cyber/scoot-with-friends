...
const TIPS=['Missions pay Credit, XP and crates. Check MISSIONS on your phone.','Daily missions change at midnight.','Crate exclusives are never sold in shops.','Sign in to keep your progress on every device.','Today\'s deals change every day. Check the shop.','Land clean for PERFECT landings.','B Hill is steep. Watch for speed wobble.','Hold D-pad Down to take your phone out.'];
let tip=-1;
